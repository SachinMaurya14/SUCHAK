 ...
 * Phase 10: HSE Action Center & Corrective/Preventive Action Types
 *
 * Strict human-in-the-loop governance:
 * AI may surface findings & patterns, but human safety officers remain
 * authoritative for action creation, assignment, verification, and closure.
 */
...
export interface ActionSourceSnapshots {
...
export interface ActionRecord {
  ...
  // Asset & site operational context
  site_id?: string | null;
  ...
  // Version snapshots
  source_snapshots?: ActionSourceSnapshots;
